...
const DocumentForm: React.FC = () => {
  ...
  //Это капитан, и я сильно подумаю принимать ли коммит пока ее не вернут в первозданный вид. Ее даже утвердили преподаватели и на кой ее менять я не понимаю и не то что бы хочу узнать.
